...
fun newTrial(numberUser: MutableList<Int>) {
    numberUser.clear()
    do {
        println("\nNeuer Versuch? y/n")
...
fun gameLoop() {
    ...
    var rndm2 = (0..9).random()
    var rndm3 = (0..9).random()
    var rndm4 = (0..9).random()

    if(rndm2 == rndm1) {
        rndm2 = (0 .. 9).random()
    }
    if (rndm3 == rndm1 || rndm3 == rndm2) {
        rndm3 = (0 .. 9).random()
    }
    if (rndm4 == rndm1 || rndm4 == rndm2 || rndm4 == rndm3) {
        rndm4 = (0 .. 9).random()
    }
